<?php
/**
*	Stores all the depreciated files from previous Yetii version
*
*	@since 1.0
*	@var array
*	@name $oldFiles
...
/**
*	Stores all the files currently used by Yetii
*
*	@since 1.0
*	@var array
*	@name $currentFiles
...
$currentFiles = array(
	...
	'register.php',
	'robots.txt',
	'admin/addnewtemplate.php',
	'admin/addsnippet.php',
	'admin/index.php',
	'admin/newpage.php',
	'admin/pages.php',
	'admin/settings.php',
	...
	'includes/error.class.php',
	'includes/errors.class.php',
	...
	'includes/jquery/js/jquery-ui-1.8.21.custom.min.js',
	...
	'snippets/Images/config.php',
	'snippets/Images/delete.php',
	'snippets/Images/Images.ini',
	'snippets/Images/index.php',
	'snippets/Images/manage.php',
	'snippets/Images/upload.php',
	...
	'templates/default/images/background.png'
);
?>